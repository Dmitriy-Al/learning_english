...
class Config {
    ...
    final val botUsername: String = "TestDemoUnicNameBot" // t.me/ForEnglishTrainingBot имя бота
    final val botToken: String = "5684975537:AAHNI1ulaYG9U0ifSlOet3r6DClVoPWl" // токен бота
